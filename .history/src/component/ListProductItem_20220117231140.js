  ...
  return (
    <Card className="overflow-hidden card__product--item">
      ...
      <Card.Body>
        ...
        <Row
          className={
            home ? "justify-content-center" : "justify-content-between px-0 pe-0 "
          }
        >
          {home ? (
            ""
            ...
            <Button
              variant="primary"
                className=" btn  card__product--item-btn  mx-0 col-xs-12 col-md-4 col-lg-2 "
          ...
          <Button
            ...
            className={
              home
                ? "card__product--item-btn mx-2 col-xs-12 col-md-4 col-lg-4"
                : " card__product--item-btn me-0 col-xs-12 col-md-4 btn btn-primary"
            }
            onClick={() =>
              addToCart(
