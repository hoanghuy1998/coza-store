      ...
      <Card.Body>
        ...
        >
          {home ? (
            ...
            <Button
              variant="primary"
              className="position-absolute card__product--item-btn mx-2 col-xs-12 col-md-1 "
          ...
          <Button
            ...
            className={
              home
                ? "card__product--item-btn mx-2 col-sm-4 col-md-4"
                : "position-absolute right-0 card__product--item-btn mx-2 col-xs-12 col-md-6"
            }
            onClick={() =>
              addToCart(
