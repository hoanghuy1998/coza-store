      ...
      <Card.Body>
        ...
        >
          {home ? (
            ...
            <Button
              variant="primary"
              className=" btn position-absolute card__product--item-btn mx-0 col-xs-12 col-md-4"
          ...
          <Button
            ...
            className={
              home
                ...
                : "position-absolute right-0 card__product--item-btn me-0 col-xs-12 col-md-4"
            }
            onClick={() =>
              addToCart(
