  ...
  return (
    <Card className="overflow-hidden card__product--item">
      ...
      <Card.Body>
        ...
        <Row
          className={
            home ? "justify-content-center" : "justify-content-center flex-row"
          }
        >
          {home ? (
            ""
            ...
            <Button
              variant="primary"
              className="position-absolute card__product--item-btn mx-0 col-sm-4 col-md-6 "
          ...
          <Button
            ...
            className={
              home
                ? "card__product--item-btn mx-2 col-sm-4 col-md-6"
