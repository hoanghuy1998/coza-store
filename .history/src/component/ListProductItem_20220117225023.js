  ...
  return (
    <Card className="overflow-hidden card__product--item">
      ...
      <Card.Body>
        ...
        <Row
          className={
            home ? "justify-content-center" : "justify-content-between"
          }
        >
          {home ? (
            ""
            ...
            <Button
              variant="primary"
              className=" btn position-absolute card__product--item-btn mx-2 col-xs-12 col-md-4"
          ...
          <Button
            ...
            className={
              home
                ...
                : "position-absolute right-0 card__product--item-btn mx-2 col-xs-12 col-md-4"
            }
            onClick={() =>
              addToCart(
